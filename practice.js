...
const people = [
    { name: "Scott", gender: "male", height: 6 },
    { name: "Alec", gender: "male", height: 6 },
    { name: "Jeddy", gender: "male", height: 5.9 }
]
...
const cowboy = {
    name: "John Wayne",
    state: "California",
    favoriteCountrySong: "My Heroes Have Always Been Cowboys"
}
...
function sayHello(greetStr, name) {
    return greetStr + " " + name
}

////////////////// PROBLEM 24 ////////////////////
// TODO combining a property name and value (duration)
...
function makeExercise(exerciseName, duration) {
    return { exerciseName: exerciseName, duration }
}
...
////////////////// PROBLEM 30 ////////////////////
// TODO line 403 says money when it should say cash, and 407 says age when it should say cash and temp
// Do not edit the code below.
let cash = "TBD"
let temp = "TBD"
// Do not edit the code above.
...
function makePurchase(priceOfItem) {
    if (priceOfItem <= user2.total) {
        user2.total = user2.total - priceOfItem
    } else {
...
// if hungry is true and tired is false, invoke and return the eat function (provided)
// if hungry is false and tired is true, invoke and return the sleep function (provided)
